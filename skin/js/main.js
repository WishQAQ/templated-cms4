var _$_60ca = ["height", "each", ".foot_box", "css", "width", ".slider .item", ".nav ul", "margin-top", "auto", "fadeIn", ".side_close", "slideDown", "click", ".nav_icon", "fadeOut", ".nav ul,.side_close", "display", "none", ".side_close,.nav_icon", "block", "position", "fixed", ".header", "hide", ".h_100", "top", "0", "offset", "69px", ".slider", "50px", "outerHeight", "body", ".footer", "href", "attr", "a", "#", "remove", "empty", ".side_r .setting", "html", "head", "dedecms", "indexOf", ".contact_mini_text p", ".contact_mini .btn_contact", "toggle", ".has_sub", ".catg_hide", "catg_hide_2", "toggleClass", ".catg_name a.on", ".catg_hide p", "MSIE 8.0", "userAgent", "cover", ".item", ".logo", "/", "slick", "#news_slider", "ready", "resize", "opacity", "1", "load"];
...
function slider_h() {
	if ($(window)[_$_60ca[4]]() > 1023) {
		$(_$_60ca[5])[_$_60ca[0]]($(window)[_$_60ca[0]]() * 0.9)
	} else {
		$(_$_60ca[5])[_$_60ca[0]]($(window)[_$_60ca[0]]() * 0.9)
	}
}
